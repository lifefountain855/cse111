...
def add_area_code(phone_number):
    ...
    """
    x=len(phone_number)
    if x > 13: print(f"Error: {phone_number} is greater than 13 chars.")
    if x < 8: print(f"Error: {phone_number} is less than 8 chars.")
    if x == 8: return "208-"+phone_number
    if x==12: return phone_number
