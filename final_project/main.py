...
def get_file_and_track(filen='',trackx=None,merge=False,instruments=[]):
    ...
    try:
        ...
        print("\033[35;1mError\033[0m: \033[35mnot an integer\033[0m")
        exit()
    except: 
        print("\033[35;1mUnexpected Error.\033[0m")
        exit()
...
def main():
    ...
    secondsd=json.dumps(seconds,indent=2)
    songs=s.songsjs
    songs=songs.replace("[SONG]",filetrack[0].removesuffix(".mid"))
    allsnippets={"manifest.json":s.manifest,"scripts/index.js":s.jscodesnip,"scripts/songs.js":songs,"data in songs.js":seconds,}
