...
def error_message(message: str="\033[3mSorry. An error occurred.\033[0m",error=None):
    if error != None: return f"\033[3mSorry, {message}. \033[0;1;35mDetails\033[0m: \033[35m{error}\033[0m"
    else: return f"\033[3mSorry, an error occurred. \033[0;1;35m{message}.\033[0m"
    ...
    try:
        with open(filename, "rt") as text_file:
            ...
            try:
                ...
                print(error_message("the numbered you entered was not a Float",err))
                return
            if perc_reduc < 0: print(error_message("The number you entered is less than zero")); return
            if perc_reduc > 100: print(error_message("The number you entered is greater than one hundred")); return
            print()
            ...
            except csv.Error as err: print(err)
    except FileNotFoundError as err:
        print(f"\033[3mSorry, you entered an invalid file name.\n\033[0;1;35mDetails\033[0m: \033[35m{err}\033[0m")
