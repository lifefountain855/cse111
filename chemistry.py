...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for list in symbol_quantity_list:
        total+=periodic_table_dict[list[0]][1]*list[1]
...
def sum_protons(symbol_quantity_list, periodic_table_dict):
    ...
    sum_pro=0
    for list in symbol_quantity_list:
        sum_pro+=list[1]*periodic_table_dict[list[0]][2]
...
def main():
    ...
    mass=float(input("Enter mass of sample: "))
    ...
    print(f"Moles: {num_moles}")

    print(f"Name of compound: {get_formula_name(formula,known_molecules_dict)}")
    
    print(f"Sum of protons: {sum_protons(parsed_formula,periodic_table)}")
    return
